...
**This website has been updated on December 19th. My opinions obviously change with experience. This will likely be updated multiple times throughout my graduate school journey.**
...
I don't regret my decision. It's interesting to see how different other institutions run.
...
You can make lots of money without a graduate degree, but the master's degree just opens more doors. Besides, everyone is getting one these days anyways...
...
You should get this type (professional) if:
...
I notice such large differences from two different yet well respected institutions. Initially I had the opinion that if I ever pursue a PhD, I would want to ensure it's at a different institution *again.* However, I've changed my opinion upon a personal realization. If you're really curious you can message/email me about it, but it will be omitted since it is inapplicable to the reader.

Now of course, finances are a huge consideration (i.e., if your parents already live near a good university and you don't have to worry about rent expenses then it isn't too bad to stay in one place). But if you're like me and you are constantly moving to one area to another & paying rent, you should absolutely be open to move.
...
There are countless of things I have noticed at McMaster compared to professors at UofT. Some include:
...
One thing I realise that UofT students care about brand names. Names do matter; but they're only one part of the application process. (If the weight was super important, I would've went into debt to go to UofT for the master's program.)
...
You want a supervisor that will actually respond to emails. A couple schools have a policy where you can't reach out to find your own supervisor (i.e., Western). However, if possible reach out to prospective supervisors and ask to get in on a meeting. If they respond, here are some very important questions to consider:
...
-   Lower ranked schools, particularly those that are not part of the U15 may have statistics masters programs that are highly cross-listed with the undergraduate courses. Many might have already been covered within the bachelors statistics program at UofT.
    ...
    -   You don't want to take redundant courses! You want to learn. (If you're doing a thesis based program though, it isn't too bad to have a bird course though...)
...
## Q: What is the best undergraduate program to enroll to be a suitable candidate for graduate school statistics?
