...
My name is Anna Ly, and I am currently pursuing a Master of Science in Statistics at McMaster University. I am honoured to be a recipient of the Ontario Graduate Scholarship, the Milos Novotny Fellowship, and the Ashbaugh Graduate Scholarship. I finished my undergraduate studies at the University of Toronto.
...
I derived exact expressions for the Pitman closeness probability for type-II hybrid censored data that follows an exponential distribution.

I was interested in the Pitman closeness criterion since, in my opinion, was more intuitive than the mean square error. However, upon completion, I admit that the mean square error is much easier to derive... Sometimes we don't need to spend months to compare two estimators...
...
-   I am a first-generation university student, and I will be the first person on my father's side of the family with a master's degree, and I would be the second on my mother's side.
